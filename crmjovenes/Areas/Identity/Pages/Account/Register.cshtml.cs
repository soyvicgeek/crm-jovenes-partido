...
namespace crmjovenes.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                .Where(r => r.Name != DS.Role_Usuario)
                .Select(n => n.Name)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(DS.Role_Coordinador))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(DS.Role_Coordinador));
                    }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            // por lo cual debemos generar su workspace
